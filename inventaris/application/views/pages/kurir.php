                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Data Kurir</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <p>
                                    <a href="<?php echo base_url('kurir_c/tambah_data')?>">
                                        <button type="button" class="btn btn-primary btn-sm">Tambah Data</button>
                                    </a>
                                </p>
                                <form method="post" action="<?php echo base_url('kurir_c/delete') ?>" id="form-delete">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                echo '<a href="'.base_url('kurir_c/edit_data/'.$baris->id_kurir).'"><button type="button" class="far fa-edit bg-warning"></button></a>';
                                            
                                            echo " ";
                                            //echo '<button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#deleteModal" data-id-data-kurir="' . $baris->id_kurir . '"></button>';
                                                ?>
                                                    <button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#hapus<?php echo $baris->id_kurir; ?>" ></button>
                                            </td>
                                            <td><input type='checkbox' class='check-item' name='id_kurir[]' value='<?php echo $baris->id_kurir; ?>'></td>
                                        </tr>
                                        <?php
                                        }?>
                                    </tbody>
...
<div class="modal fade" id="hapus<?php echo $baris->id_kurir; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="col-md-11 mx-3">
                        <div class="p-20">
                            ...
                            <div class="text-center m-t-15">
                                <a href="<?php echo base_url('kurir_c/hapus_data/'.$baris->id_kurir);?>">
