...
<form class="user" method="post" action="<?php echo base_url('master_user_c/update'); ?>" enctype="multipart/form-data">

<div class="container-fluid pt-4 px-3">
        <div class="text-left mx-auto mb-4">
            <h5>Edit Master User</h5>
        </div>
                ...
                <div class="card m-b-30">
                    <div class="card-body px-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" value="<?= $user['autor'] ?>" id="autor" name="autor" required="" placeholder="">
                            </div>
                        </div>
