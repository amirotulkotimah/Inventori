...
<div class="container-fluid pt-4 px-3">
        <div class="text-left mx-auto mb-4">
            <h5>Statistik Kategori Skincare</h5>
        </div>
            <div class="row">
                        ...
                        <div class="card mini-stat">
                            ...
                            <div class="p-4">
                                ...
                                <div class="float-right">
                                    <h4 class="mb-0"><?php echo $total_stok_skincare; ?><small class="ml-2"><i class=""></i></small></h4>
                                </div>
    ...
    series: [
        {
            ...
            data: [
                {
                    name: ">=1 Minggu",
                    y: <?php echo json_encode($total_bm_skincare_1minggu); ?>, 
                    drilldown: ">=1 Minggu"
                },
                {
                    name: ">=2 Minggu",
                    y: <?php echo json_encode($total_bm_skincare_2minggu); ?>,
                    drilldown: ">=2 Minggu"
                },
                {
                    name: ">= 1 Bulan",
                    y: <?php echo json_encode($total_bm_skincare_1bulan); ?>,
                    drilldown: ">= 1 Bulan"
                },
                {
                    name: ">= 2 Bulan",
                    y: <?php echo json_encode($total_bm_skincare_2bulan); ?>,
                    drilldown: ">= 2 Bulan"
                }
            ]
        }
