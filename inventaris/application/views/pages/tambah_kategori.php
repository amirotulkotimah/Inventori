...
<form class="user" action="<?php echo base_url('kategori_c/input_data');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card m-b-30">
                    <div class="card-body px-5">
                        ...
                        <div class="form-group row py-1">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" value="" id="nama_kategori" name="nama_kategori" required="" placeholder="">
                            </div>
                        </div>
