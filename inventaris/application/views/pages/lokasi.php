                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <p>
                                    <a href="<?php echo base_url('lokasi_c/tambah_data')?>">
                                        <button type="button" class="btn btn-primary btn-sm">Tambah Data</button>
                                    </a>
                                </p>
                                <form method="post" action="<?php echo base_url('lokasi_c/delete') ?>" id="form-delete">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                echo '<a href="'.base_url('lokasi_c/edit_data/'.$baris->id_lokasi).'"><button type="button" class="far fa-edit bg-warning"></button></a>';
                                            
                                            echo " ";
                                            //echo '<button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#deleteModal" data-id-data-lokasi="' . $baris->id_lokasi . '"></button>';
                                                ?>
                                                    <button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#hapus<?php echo $baris->id_lokasi; ?>" ></button>
                                            </td>
                                            <td><input type='checkbox' class='check-item' name='id_lokasi[]' value='<?php echo $baris->id_lokasi; ?>'></td>
                                        </tr>
                                        <?php
                                        }?>
                                    </tbody>
...
<div class="modal fade" id="hapus<?php echo $baris->id_lokasi; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="col-md-11 mx-3">
                        <div class="p-20">
                            ...
                            <div class="text-center m-t-15">
                                <a href="<?php echo base_url('lokasi_c/hapus_data/'.$baris->id_lokasi);?>">
