                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <p>
                                    <a href="<?php echo base_url('kategori_c/tambah_data')?>">
                                        <button type="button" class="btn btn-primary btn-sm">Tambah Data</button>
                                    </a>
                                </p>
                                <form method="post" action="<?php echo base_url('kategori_c/delete') ?>" id="form-delete">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                echo '<a href="'.base_url('kategori_c/edit_data/'.$baris->id_kategori).'"><button type="button" class="far fa-edit bg-warning"></button></a>';
                                            
                                            echo " ";
                                            //echo '<button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#deleteModal" data-id-data-kategori="' . $baris->id_kategori . '"></button>';
                                                ?>
                                                <button type="button" class="far fa-trash-alt bg-danger" data-toggle="modal" data-target="#hapus<?php echo $baris->id_kategori; ?>" ></button>
                                            </td>
                                            <td><input type='checkbox' class='check-item' name='id_kategori[]' value='<?php echo $baris->id_kategori; ?>'></td>
                                        </tr>
                                        <?php
                                        }?>
                                    </tbody>
...
<div class="modal fade" id="hapus<?php echo $baris->id_kategori; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="col-md-11 mx-3">
                        <div class="p-20">
                            ...
                            <div class="text-center m-t-15">
                                <a href="<?php echo base_url('kategori_c/hapus_data/'.$baris->id_kategori);?>">
